...
import com.concentrix.asset.entity.SnapshotDeviceId;
...
public interface SnapshotDeviceRepository
    extends JpaRepository<SnapshotDevice, SnapshotDeviceId>, JpaSpecificationExecutor<SnapshotDevice> {

  List<SnapshotDevice> findAllByDevice(Device device);

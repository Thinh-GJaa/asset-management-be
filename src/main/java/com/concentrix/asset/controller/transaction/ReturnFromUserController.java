...
public class ReturnFromUserController {
        ...
        public ResponseEntity<ApiResponse<Page<ReturnFromUserResponse>>> filterReturnFromUser(
                ...
                ApiResponse<Page<ReturnFromUserResponse>> apiResponse = ApiResponse
                                .<Page<ReturnFromUserResponse>>builder()
        ...
        @PostMapping("/{returnId}/upload-image")
        public ResponseEntity<ApiResponse<Void>> uploadImage(
                        @PathVariable Integer returnId,
                        @RequestParam("images") List<MultipartFile> images,
                        HttpServletRequest request) {
                log.info("[ReturnFromUserController] Content-Type = {}", request.getContentType());
                returnFromUserService.uploadImage(returnId, images);
